...
">
    ...
    <p style="color:#555; margin:0; font-size:0.95rem; line-height:1.5;">
        식단 검토 신청 시스템<br>전문가가 직접 분석해 드립니다
    </p>
</div>
...
<div style="padding:1rem 0; border-bottom:2px solid #e8e8e8; margin-bottom:1.2rem;">
    <h2 style="margin:0; color:#3a2a1a;">🐾 반려견 영양연구소</h2>
    <p style="color:#555; margin:0.2rem 0 0 0; font-size:0.95rem;">식단 검토 신청 시스템 — 전문가가 직접 분석해 드립니다</p>
</div>
""", unsafe_allow_html=True)
