...
.home-wrap{max-width:1180px;margin:0 auto;color:#153e2b}.home-hero{min-height:276px;padding:1.55rem 2.1rem;border:1px solid #e6eadb;border-radius:28px;background:linear-gradient(140deg,#fffdf8 0%,#fbfcf4 65%,#f3f7ea 100%);position:relative;overflow:hidden;box-shadow:0 8px 24px rgba(35,73,44,.055)}.home-hero:before{content:'🐾';position:absolute;left:3.5%;top:20%;font-size:2rem;color:#8eae7a;opacity:.11}.home-hero:after{content:'🐾  ·  🐾';position:absolute;right:2.4%;top:8%;color:#84a96e;opacity:.15;font-size:1.65rem}.home-symbol{width:114px;height:112px;overflow:hidden;flex:0 0 114px;position:relative}.home-symbol img{width:282px;max-width:none;position:absolute;left:-13px;top:-20px}.home-eyebrow{margin:0 0 .4rem;color:#739268;font-size:.88rem;font-weight:800;letter-spacing:.04em}.home-title{margin:0;color:#075c38;font-size:clamp(2.25rem,4.7vw,3.7rem);font-weight:900;letter-spacing:-.075em;line-height:1.08}.home-leaf{display:inline-block;margin-left:.2rem;color:#62a649;font-size:.88em;transform:rotate(-12deg)}.home-lead{max-width:590px;margin:.65rem 0 0;color:#254838;font-size:1.1rem;line-height:1.65;font-weight:600}.home-hero-side{position:absolute;right:2.3rem;bottom:-1.2rem;width:265px;height:245px;overflow:hidden;z-index:1}.home-fluffy{width:248px;height:auto;position:absolute;bottom:-60px;left:8px;object-fit:contain}.bubble{position:absolute;right:17.4rem;bottom:5.2rem;z-index:2;max-width:165px;padding:.62rem .78rem;border:1px solid #d8e4cc;border-radius:15px;background:rgba(255,255,252,.9);box-shadow:0 3px 12px rgba(30,70,43,.06);color:#27613c;font-size:.9rem;font-weight:800;line-height:1.48}.bubble:after{content:'';position:absolute;right:-8px;bottom:12px;border-width:7px 0 7px 9px;border-style:solid;border-color:transparent transparent transparent #d8e4cc}.home-steps{display:grid;grid-template-columns:repeat(4,1fr);gap:0;margin:1.05rem 0;padding:1.35rem 1.15rem;background:#fffefa;border:1px solid #e2e8dc;border-radius:22px;box-shadow:0 5px 16px rgba(30,70,43,.055)}.home-step{min-height:132px;position:relative;padding:.05rem 1.1rem;text-align:center}.home-step:not(:last-child):after{content:'›';position:absolute;right:-.16rem;top:40%;color:#9cad94;font-size:2.4rem;font-weight:300}.step-head{display:flex;align-items:center;justify-content:center;gap:.52rem;margin-bottom:.52rem}.step-num{display:inline-flex;width:34px;height:34px;border-radius:50%;align-items:center;justify-content:center;background:#5aa35c;color:#fff;font-weight:900;box-shadow:0 2px 5px rgba(54,122,60,.17)}.step-icon{display:inline-flex;width:31px;height:31px;border:2px solid #287145;border-radius:9px;align-items:center;justify-content:center;color:#287145;font-size:1rem;font-weight:900}.home-step b{display:block;color:#0d5634;font-size:1rem}.home-step p{margin:.34rem 0 0;color:#53645a;font-size:.88rem;line-height:1.48}.home-auth-copy h2{margin:0 0 .42rem;color:#0b5735;font-size:clamp(1.7rem,3vw,2.3rem);letter-spacing:-.045em}.home-auth-copy p{margin:0;color:#465a4e;font-size:1rem;line-height:1.65}.home-auth-card{margin:1.05rem 0!important;padding:1.35rem 1.55rem!important;border:1px solid #e3e8dc!important;border-radius:23px!important;background:#fffefa!important;box-shadow:0 7px 20px rgba(30,70,43,.05)!important}.home-auth-card [data-testid="stButton"] button{background:#378c4b!important;border-color:#378c4b!important;border-radius:11px!important;font-weight:850!important;font-size:1.02rem!important;min-height:3.22rem!important}.home-auth-card [data-testid="stButton"] button:hover{background:#28783b!important;border-color:#28783b!important}.home-deco{align-self:stretch;min-height:185px;display:flex;align-items:center;justify-content:center;padding:1.2rem 1.45rem;border-radius:53% 47% 55% 45%;background:#f0f6e7;color:#185437;position:relative;overflow:hidden}.home-deco:before{content:'🌿';position:absolute;left:15%;top:13%;font-size:2rem;opacity:.83}.home-deco:after{content:'🐾';position:absolute;right:12%;bottom:11%;font-size:1.6rem;color:#8ebd7d;opacity:.55}.home-deco p{max-width:180px;margin:0;color:#20563a;font-size:1.27rem;font-weight:800;line-height:1.55;text-align:center}.home-channel{display:flex;gap:1.15rem;align-items:center;margin-top:1.15rem;padding:1rem 1.25rem;background:#f8faf2;border:1px solid #dde7d7;border-radius:17px}.home-channel-qr{width:78px;height:78px;object-fit:contain;flex:0 0 auto}.channel-intro{min-width:220px;padding-right:1rem;border-right:1px solid #d9e3d5}.channel-intro b{display:block;color:#155b37;font-size:1rem}.channel-intro span{display:block;margin-top:.25rem;color:#59675d;font-size:.84rem}.channel-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:.55rem;flex:1}.channel-item{display:flex;align-items:flex-start;gap:.45rem;padding:.25rem .2rem}.channel-dot{display:inline-flex;flex:0 0 26px;height:26px;align-items:center;justify-content:center;border-radius:7px;color:#fff;font-size:.82rem;font-weight:900}.yt{background:#ef4b42}.naver{background:#2dbd5c}.audio{background:#8852d9}.kakao{background:#f4c321;color:#543f00}.channel-item b{display:block;color:#155b37;font-size:.9rem}.channel-item small{display:block;margin-top:.12rem;color:#59675d;font-size:.76rem;line-height:1.35}.home-bottom{display:flex;justify-content:space-between;gap:1rem;margin:.75rem .1rem 1rem;color:#68736a;font-size:.78rem}.home-bottom span:last-child{color:#477047}.home-auth-card [data-testid="stTextInput"]{max-width:620px}@media(max-width:780px){.home-hero{min-height:230px;padding:1.25rem 1.1rem}.home-symbol{width:72px;height:68px;opacity:.72}.home-symbol img{width:176px;left:-7px;top:-12px}.home-eyebrow{font-size:.78rem}.home-title{font-size:2.08rem}.home-lead{max-width:70%;font-size:.94rem}.home-hero-side{right:-.7rem;bottom:-3.2rem;width:150px;height:155px}.home-fluffy{width:154px;bottom:-40px;left:0}.bubble{display:none}.home-steps{grid-template-columns:repeat(2,1fr);padding:.7rem}.home-step{min-height:118px;padding:.35rem .5rem}.home-step:nth-child(2):after{display:none}.home-step:not(:last-child):after{right:-.25rem}.home-auth-card{padding:1.15rem!important}.home-deco{display:none}.home-channel{align-items:flex-start;flex-wrap:wrap}.channel-intro{border-right:0;padding-right:0}.channel-grid{grid-template-columns:repeat(2,1fr);width:100%}.home-bottom{display:block;line-height:1.7}.home-bottom span{display:block}}
.home-wrap{max-width:1180px;margin:0 auto;color:#153e2b}.home-hero{min-height:276px;padding:1.55rem 2.1rem;border:1px solid #e6eadb;border-radius:28px;background:linear-gradient(140deg,#fffdf8 0%,#fbfcf4 65%,#f3f7ea 100%);position:relative;overflow:visible;box-shadow:0 8px 24px rgba(35,73,44,.055)}.home-hero:before{content:'🐾';position:absolute;left:3.5%;top:20%;font-size:2rem;color:#8eae7a;opacity:.11}.home-hero:after{content:'🐾  ·  🐾';position:absolute;right:2.4%;top:8%;color:#84a96e;opacity:.15;font-size:1.65rem}.home-symbol{width:96px;height:auto;flex:0 0 96px;position:relative}.home-symbol img{display:block;width:100%;height:auto;max-width:100%;position:static}.home-eyebrow{margin:0 0 .4rem;color:#739268;font-size:.88rem;font-weight:800;letter-spacing:.04em}.home-title{margin:0;color:#075c38;font-size:clamp(2.25rem,4.7vw,3.7rem);font-weight:900;letter-spacing:-.075em;line-height:1.08}.home-leaf{display:inline-block;margin-left:.2rem;color:#62a649;font-size:.88em;transform:rotate(-12deg)}.home-lead{max-width:590px;margin:.65rem 0 0;color:#254838;font-size:1.1rem;line-height:1.65;font-weight:600}.home-hero-side{position:absolute;right:2.3rem;bottom:0;width:255px;height:auto;z-index:1}.home-fluffy{display:block;width:100%;height:auto;position:static;max-width:100%}.bubble{position:absolute;right:18.5rem;bottom:5.2rem;z-index:2;max-width:165px;padding:.62rem .78rem;border:1px solid #d8e4cc;border-radius:15px;background:rgba(255,255,252,.9);box-shadow:0 3px 12px rgba(30,70,43,.06);color:#27613c;font-size:.9rem;font-weight:800;line-height:1.48}.bubble:after{content:'';position:absolute;right:-8px;bottom:12px;border-width:7px 0 7px 9px;border-style:solid;border-color:transparent transparent transparent #d8e4cc}.home-steps{display:grid;grid-template-columns:repeat(4,1fr);gap:0;margin:1.05rem 0;padding:1.35rem 1.15rem;background:#fffefa;border:1px solid #e2e8dc;border-radius:22px;box-shadow:0 5px 16px rgba(30,70,43,.055)}.home-step{min-height:132px;position:relative;padding:.05rem 1.1rem;text-align:center}.home-step:not(:last-child):after{content:'›';position:absolute;right:-.16rem;top:40%;color:#9cad94;font-size:2.4rem;font-weight:300}.step-head{display:flex;align-items:center;justify-content:center;gap:.52rem;margin-bottom:.52rem}.step-num{display:inline-flex;width:34px;height:34px;border-radius:50%;align-items:center;justify-content:center;background:#5aa35c;color:#fff;font-weight:900;box-shadow:0 2px 5px rgba(54,122,60,.17)}.step-icon{display:inline-flex;width:31px;height:31px;border:2px solid #287145;border-radius:9px;align-items:center;justify-content:center;color:#287145;font-size:1rem;font-weight:900}.home-step b{display:block;color:#0d5634;font-size:1rem}.home-step p{margin:.34rem 0 0;color:#53645a;font-size:.88rem;line-height:1.48}.home-auth-copy h2{margin:0 0 .42rem;color:#0b5735;font-size:clamp(1.7rem,3vw,2.3rem);letter-spacing:-.045em}.home-auth-copy p{margin:0;color:#465a4e;font-size:1rem;line-height:1.65}.home-auth-card{margin:1.05rem 0!important;padding:1.35rem 1.55rem!important;border:1px solid #e3e8dc!important;border-radius:23px!important;background:#fffefa!important;box-shadow:0 7px 20px rgba(30,70,43,.05)!important}.home-auth-card [data-testid="stButton"] button{background:#378c4b!important;border-color:#378c4b!important;border-radius:11px!important;font-weight:850!important;font-size:1.02rem!important;min-height:3.22rem!important}.home-auth-card [data-testid="stButton"] button:hover{background:#28783b!important;border-color:#28783b!important}.home-deco{align-self:stretch;min-height:185px;display:flex;align-items:center;justify-content:center;padding:1.2rem 1.45rem;border-radius:53% 47% 55% 45%;background:#f0f6e7;color:#185437;position:relative;overflow:hidden}.home-deco:before{content:'🌿';position:absolute;left:15%;top:13%;font-size:2rem;opacity:.83}.home-deco:after{content:'🐾';position:absolute;right:12%;bottom:11%;font-size:1.6rem;color:#8ebd7d;opacity:.55}.home-deco p{max-width:180px;margin:0;color:#20563a;font-size:1.27rem;font-weight:800;line-height:1.55;text-align:center}.home-channel{display:flex;gap:1.15rem;align-items:center;margin-top:1.15rem;padding:1rem 1.25rem;background:#f8faf2;border:1px solid #dde7d7;border-radius:17px}.home-channel-qr{width:78px;height:78px;object-fit:contain;flex:0 0 auto}.channel-intro{min-width:220px;padding-right:1rem;border-right:1px solid #d9e3d5}.channel-intro b{display:block;color:#155b37;font-size:1rem}.channel-intro span{display:block;margin-top:.25rem;color:#59675d;font-size:.84rem}.channel-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:.55rem;flex:1}.channel-item{display:flex;align-items:flex-start;gap:.45rem;padding:.25rem .2rem}.channel-dot{display:inline-flex;flex:0 0 26px;height:26px;align-items:center;justify-content:center;border-radius:7px;color:#fff;font-size:.82rem;font-weight:900}.yt{background:#ef4b42}.naver{background:#2dbd5c}.audio{background:#8852d9}.kakao{background:#f4c321;color:#543f00}.channel-item b{display:block;color:#155b37;font-size:.9rem}.channel-item small{display:block;margin-top:.12rem;color:#59675d;font-size:.76rem;line-height:1.35}.home-bottom{display:flex;justify-content:space-between;gap:1rem;margin:.75rem .1rem 1rem;color:#68736a;font-size:.78rem}.home-bottom span:last-child{color:#477047}.home-auth-card [data-testid="stTextInput"]{max-width:620px}@media(max-width:780px){.home-hero{min-height:230px;padding:1.25rem 1.1rem}.home-symbol{width:72px;height:auto;opacity:1}.home-symbol img{width:100%;height:auto;left:auto;top:auto}.home-eyebrow{font-size:.78rem}.home-title{font-size:2.08rem}.home-lead{max-width:70%;font-size:.94rem}.home-hero-side{right:.5rem;bottom:0;width:145px;height:auto}.home-fluffy{width:100%;height:auto;bottom:auto;left:auto}.bubble{display:none}.home-steps{grid-template-columns:repeat(2,1fr);padding:.7rem}.home-step{min-height:118px;padding:.35rem .5rem}.home-step:nth-child(2):after{display:none}.home-step:not(:last-child):after{right:-.25rem}.home-auth-card{padding:1.15rem!important}.home-deco{display:none}.home-channel{align-items:flex-start;flex-wrap:wrap}.channel-intro{border-right:0;padding-right:0}.channel-grid{grid-template-columns:repeat(2,1fr);width:100%}.home-bottom{display:block;line-height:1.7}.home-bottom span{display:block}}
</style>
""", unsafe_allow_html=True)

st.markdown("""
<style>
div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-auth-copy) {
  margin:1.05rem 0!important; border:1px solid #e3e8dc!important;
  border-radius:23px!important; background:#fffefa!important;
  box-shadow:0 7px 20px rgba(30,70,43,.05)!important;
}
div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-auth-copy) [data-testid="stButton"] button {
  background:#378c4b!important; border-color:#378c4b!important; border-radius:11px!important;
  font-weight:850!important; font-size:1.02rem!important; min-height:3.22rem!important;
}
div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-auth-copy) [data-testid="stButton"] button:hover {
  background:#28783b!important; border-color:#28783b!important;
}
.home-hero .bubble {
  width:190px; min-width:190px; max-width:190px; white-space:nowrap;
}
.home-channel .channel-grid {grid-template-columns:repeat(5,minmax(0,1fr));gap:.4rem;}
.home-channel a.channel-item {color:inherit;text-decoration:none;border-radius:10px;transition:background-color .15s ease,transform .15s ease;}
.home-channel a.channel-item:hover {background:rgba(91,163,92,.09);transform:translateY(-1px);}
.instagram {background:linear-gradient(135deg,#b84e91,#e27555);}
.home-channel {gap:.65rem;padding:.85rem 1rem;}
.home-channel-qr {width:68px;height:68px;}
.channel-intro {min-width:190px;}
.home-channel .channel-grid {grid-template-columns:repeat(5,minmax(145px,1fr));gap:.2rem;}
.home-channel .channel-item {min-width:0;gap:.35rem;padding:.25rem .1rem;}
.home-channel .channel-item > div {min-width:0;}
.home-channel .channel-item small {font-size:.71rem;white-space:nowrap;word-break:keep-all;overflow-wrap:normal;}
.home-channel .channel-logo {display:block;flex:0 0 28px;width:28px;height:28px;object-fit:contain;}
.home-channel .naver-premium-logo {width:32px;flex-basis:32px;}
@media(max-width:1040px) {
  .home-channel {flex-wrap:wrap;}
  .home-channel .channel-grid {width:100%;flex-basis:100%;grid-template-columns:repeat(5,minmax(0,1fr));gap:.35rem;}
}
@media(max-width:860px) {
  .home-channel .channel-grid {grid-template-columns:repeat(3,minmax(0,1fr));}
  .home-channel .channel-item small {white-space:normal;}
}
@media(max-width:780px) {
  .home-hero .bubble {width:auto;min-width:0;max-width:165px;white-space:normal;}
  .home-channel .channel-grid {grid-template-columns:repeat(2,1fr);}
}
</style>
""", unsafe_allow_html=True)
...
_qr   = _qr_b64()
_fluffy = _fluffy_b64()
_hero_logo_symbol = _image_b64("logo_symbol.png")
_hero_fluffy = _image_b64("fluffy_hero.png")
_naver_premium_logo = _image_b64("naver_premium.png")
_audioletter_logo = _image_b64("audioletter.png")
_instagram_logo = _image_b64("instagram.png")

_qr_tag = f'<img src="data:image/png;base64,{_qr}" style="width:78px; height:78px; object-fit:contain;" />' if _qr else ''
_naver_premium_tag = f'<img class="channel-logo naver-premium-logo" src="data:image/png;base64,{_naver_premium_logo}" alt="네이버 프리미엄 콘텐츠" />' if _naver_premium_logo else '<span class="channel-dot naver">N</span>'
_audioletter_tag = f'<img class="channel-logo audioletter-logo" src="data:image/png;base64,{_audioletter_logo}" alt="오디오레터" />' if _audioletter_logo else '<span class="channel-dot audio">◉</span>'
_instagram_tag = f'<img class="channel-logo instagram-logo" src="data:image/png;base64,{_instagram_logo}" alt="Instagram" />' if _instagram_logo else '<span class="channel-dot instagram">◎</span>'
...
with tab_user:
    if not st.session_state.authenticated:
        hero_symbol = f'<div class="home-symbol"><img src="data:image/png;base64,{_hero_logo_symbol}" alt="나무볕 로고 심볼" /></div>' if _hero_logo_symbol else ''
        hero_fluffy = f'<div class="home-hero-side"><img class="home-fluffy" src="data:image/png;base64,{_hero_fluffy}" alt="플러피" /></div>' if _hero_fluffy else ''
        st.markdown(f'''<div class="home-wrap">
          <section class="home-hero">
            <div style="display:flex;align-items:flex-start;gap:1.15rem;position:relative;z-index:2;">
              {hero_symbol}
              <div style="padding-top:.1rem;">
                <p class="home-eyebrow">우리 아이의 건강한 오늘을 위한</p>
                <h1 class="home-title">반려견 식단 분석 <span class="home-leaf">❧</span></h1>
                <p class="home-lead">지금 먹고 있는 식단을 영양 기준과 함께 꼼꼼하게 살펴보고,<br>더 건강한 식단으로 제안해드립니다.</p>
              </div>
            </div>
            <div class="bubble">우리 아이의 건강한 식단,<br>함께 만들어봐요! 🧡</div>
            {hero_fluffy}
          </section>
          <section class="home-steps" aria-label="식단 분석 이용 과정">
            <div class="home-step"><div class="step-head"><span class="step-num">1</span><span class="step-icon">▣</span></div><b>이용권 확인</b><p>구매하신 이용권으로<br>식단 분석을 시작합니다.</p></div>
            <div class="home-step"><div class="step-head"><span class="step-num">2</span><span class="step-icon">◒</span></div><b>식단 정보 입력</b><p>지금 먹고 있는 식단과<br>아이의 생활 정보를 입력해주세요.</p></div>
            <div class="home-step"><div class="step-head"><span class="step-num">3</span><span class="step-icon">⌕</span></div><b>전문가 영양 분석</b><p>수의 영양학 전문가가<br>꼼꼼하게 분석합니다.</p></div>
            <div class="home-step"><div class="step-head"><span class="step-num">4</span><span class="step-icon">✉</span></div><b>이메일로 결과 확인</b><p>영업일 기준 5일 이내<br>분석 결과를 보내드립니다.</p></div>
          </section>
        </div>''', unsafe_allow_html=True)
        with st.container(border=True):
            auth_left, auth_right = st.columns([3, 1])
            with auth_left:
                st.markdown('''<div class="home-auth-copy"><h2>🔒 식단 분석을 시작해볼까요?</h2><p>반려견 식단 분석 이용권을 구매하신 분만 이용하실 수 있습니다.<br>결제 시 입력하신 전화번호를 먼저 확인해주세요.</p></div>''', unsafe_allow_html=True)
            ...
            with auth_right:
                st.markdown('<div class="home-deco"><p>아이의 작은 식사가<br>더 건강한 내일을 만듭니다.</p></div>', unsafe_allow_html=True)
        st.markdown(f'''<div class="home-wrap">
          <section class="home-channel">
            {_qr_tag}
            <div class="channel-intro"><b>반려견영양연구소와<br>더 가까이 만나보세요!</b><span>반려견의 건강은 오늘의 식단에서 시작됩니다.</span></div>
            <div class="channel-grid">
              <a class="channel-item" href="https://www.youtube.com/@dognutrtionlab" target="_blank" rel="noopener noreferrer" aria-label="YouTube 열기"><span class="channel-dot yt">▶</span><div><b>YouTube</b><small>전문가의 영양 정보</small></div></a>
              <a class="channel-item" href="https://contents.premium.naver.com/dognutritionlab/dognutrition" target="_blank" rel="noopener noreferrer" aria-label="네이버 프리미엄 열기">{_naver_premium_tag}<div><b>네이버 프리미엄</b><small>반려견 영양 콘텐츠</small></div></a>
              <a class="channel-item" href="https://quixotic-perch-365.notion.site/3a1d0447f5c4809680abc1206e0a21c3?source=copy_link" target="_blank" rel="noopener noreferrer" aria-label="오디오 레터 열기">{_audioletter_tag}<div><b>오디오 레터</b><small>더 깊이 있는 영양 이야기</small></div></a>
              <a class="channel-item" href="http://pf.kakao.com/_excbpn" target="_blank" rel="noopener noreferrer" aria-label="카카오채널 열기"><span class="channel-dot kakao">T</span><div><b>카카오채널</b><small>실시간 상담 및 소식</small></div></a>
              <a class="channel-item" href="https://www.instagram.com/dognutritionlab" target="_blank" rel="noopener noreferrer" aria-label="Instagram 열기">{_instagram_tag}<div><b>Instagram</b><small>짧고 유익한 건강 정보</small></div></a>
            </div>
          </section>
          <footer class="home-bottom"><span>© 반려견 영양연구소 · 무단 전재 및 재배포를 금합니다.</span><span>🐾 반려견 건강한 오늘, 더 행복한 내일을 위해</span></footer>
        </div>''', unsafe_allow_html=True)
        st.stop()
