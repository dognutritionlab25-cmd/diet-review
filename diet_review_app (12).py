...
with tab_user:
    if not st.session_state.authenticated:
        hero_symbol = f'<div class="home-symbol"><img src="data:image/png;base64,{_logo}" alt="반려견영양연구소" /></div>' if _logo else ''
        hero_fluffy = f'<div class="home-hero-side"><img class="home-fluffy" src="data:image/png;base64,{_fluffy}" alt="플러피" /></div>' if _fluffy else ''
